    ...
    <>
      ...
      >
        <Link
          ...
          className="glass-card block overflow-hidden rounded-lg transition-shadow hover:shadow-lg hover:shadow-accent-700/10"
        >
          <div className="relative aspect-square bg-ink-950">
            ...
            {isProdutoNovo(product.created_at) && (
              <span className="absolute left-2 top-2 rounded-full bg-accent-700 px-2 py-0.5 text-xs font-medium text-white">
                Novo
              </span>
            )}
          </div>
          <div className="p-3">
            ...
            <p className="font-mono text-sm text-accent-500">{formatPrice(product.price)}</p>
          </div>
        </Link>
