          ...
          <div className="mt-2 flex flex-wrap gap-2" role="radiogroup" aria-label="Cores disponíveis">
            {colors.map((color) => (
              <button
                ...
                className={`h-8 w-8 rounded-full ring-2 transition-shadow focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-300 ${
                  selectedColor?.id === color.id ? "ring-brand-300" : "ring-ink-800 hover:ring-ink-200"
                }`}
