    ...
    >
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-full border border-ink-800 bg-ink-900 py-1.5 pl-8 pr-3 text-sm text-ink-50 placeholder:text-ink-400 focus:outline-none focus:ring-1 focus:ring-brand-500"
        />
      </div>
    </form>
  );
